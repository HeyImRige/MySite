...
angularApp.controller('mainController',['$scope','$sce','$window', function($scope,$sce,$window) {
    ...
    $scope.projects = [
		...
		{"type":"software","date":1480226400000,"title":"Custome Juce Knob","media":"IMAGES/juceKnob.gif","content":"Juce is an toolkit for designing and implmenting audio software. This project was to implement a cleaner interface that could be used on a wide variety of projects. The knob generated is vectorized to allow for scaleable window sizes as well as versatility in use.","contentSmall":"Juce is a toolkit for developing audio applications. This project implmented a simple way to generate clean GUI elements that can be used in a wide range of situations.","additionalLink":"https://github.com/RobertAron/JuceCustomGraphics","additionalText":"View Repo"}
    ];
