...
angularApp.controller('mainController',['$scope','$sce','$window', function($scope,$sce,$window) {
    ...
    $scope.projects = [
        ...
        {"type":"software","date":1420113600,"title":"Never Late Smart Alarm","media":"https://puu.sh/rkrA7/c8d7a3517e.png","content":"Never late smart alarm is a native android appliacation. Type in your destination and time you need to be there, and it will notify you when you need to leave. Google traffic data is called in real time, so you wont be surprised by wrecks on your commute to work. Sudden snow storms or road closing are no worry either. Sleep easy!","additionalLink":"http://devpost.com/software/neverlate-smartalarm-1vyjbi","contentSmall":"lil bit of information here","additionalText":"Read more on Devpost"},
