...
angularApp.controller('mainController',['$scope','$sce','$window', function($scope,$sce,$window) {
    ...
    $scope.projects = [
        ...
        {"type":"software","date":1460869200000,"title":"Never Late Smart Alarm","media":"smartAlarm.png","content":"Never late smart alarm is a native android appliacation. Type in your destination and time you need to be there, and it will notify you when you need to leave. Google traffic data is called in real time, so you wont be surprised by wrecks on your commute to work. Sudden snow storms or road closing are no worry either. Sleep easy!","additionalLink":"http://devpost.com/software/neverlate-smartalarm-1vyjbi","contentSmall":"Never late smart alarm is a native android appliacation. It uses real time google traffic data, so you'll never be late due to traffic!","additionalText":"Read more on Devpost"},
        {"type":"software","date":1420113600,"title":"This Site","media":"imgur.com","content":"hello this is some information about that software thing"},
        {"type":"software","date":1420113600,"title":"UTA Now","media":"imgur.com","content":"hello this is some information about that software thing"},
